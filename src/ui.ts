...
import { Scene, GroupObject } from './scene';
...
export class UIEngine {
    ...
    drawToolbar(canvas: Canvas, height: number) {
    ...
    drawPropertiesPanel(canvas: Canvas, width: number, height: number) {
    ...
    drawMenubar(canvas: Canvas, width: number) {
        const bgPaint = new this.ck.Paint();
